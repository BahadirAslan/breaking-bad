    ...
    return (
        <div className="card">
            <div className="card-header">
                <a href={`https://breaking-bad-kappa.vercel.app/${character.char_id}`} className="header-text">{character.name}</a>
                <a href={`https://breaking-bad-kappa.vercel.app/${character.char_id}`}>
